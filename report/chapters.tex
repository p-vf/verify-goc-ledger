...
\subsection{Logs} \todo{this might be unnecessary}
...
\subsection{Verifying the invariants \(M1\) to \(M7\), \(F1\), \(F2\), and \(F3\)}
...
\subsection{Verifying the invariants \(d1\) to \(d8\)}
...
\section{Git Repository as Ledger}
\begin{figure}[h!]
    \dirtree{%
    .1 refs/.
    .2 heads/.
...
\subsection{Encoding Messages as Git Commits}
